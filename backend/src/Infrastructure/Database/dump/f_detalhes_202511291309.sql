INSERT INTO pobj_refactor.f_detalhes (contrato_id,registro_id,funcional,id_produto,dt_cadastro,competencia,valor_meta,valor_realizado,quantidade,peso,pontos,dt_vencimento,dt_cancelamento,motivo_cancelamento,canal_venda,tipo_venda,condicao_pagamento,status_id) VALUES
